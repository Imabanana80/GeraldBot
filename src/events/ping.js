  ...
  async run(client, message) {
    if (
      ...
      const pingembed = new EmbedBuilder()
        ...
        .setColor(0xfaff86)
        .setDescription(
          "To see a full list of my [slash commands](https://support.discord.com/hc/en-us/articles/1500000368501-Slash-Commands-FAQ) check out the [wiki](https://github.com/Imabanana80/GeraldBot/wiki) page or type / and click my icon. If you need more help feel free to contact the developers [here](https://discord.gg/5GxWqAEdez)"
        );
